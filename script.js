const projects = [
  ...
  { type: 'design', kind: 'image', src: './Assets/MOTIVATION_QUATE.png' },
  { type: 'design', kind: 'image', src: './Assets/MAKEUP_HAIRSTYLEInstagram_Post.png' },
  { type: 'design', kind: 'image', src: './Assets/Makeup_Class_Instagram_Post.png' },
  { type: 'design', kind: 'image', src: './Assets/magizen.png' },
  { type: 'design', kind: 'image', src: './Assets/lowest_price.png' },
  { type: 'design', kind: 'image', src: './Assets/logo_and_visiting_card.png' },
  { type: 'design', kind: 'image', src: './Assets/holi_deal.png' },
  { type: 'design', kind: 'image', src: './Assets/Bridal_Makeup_Instagram_Post.png' },
  { type: 'design', kind: 'image', src: './Assets/before_after_look.jpg' },
  { type: 'design', kind: 'image', src: './Assets/banner__packing_.png' },
  { type: 'design', kind: 'image', src: './Assets/49_POST.png' },
